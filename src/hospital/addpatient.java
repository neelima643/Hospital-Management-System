...
public class addpatient extends JFrame {
	...
	public addpatient() {
		...
		lblNewLabel_1.setBounds(53, 76, 114, 34);
		...
		textField.setBounds(261, 85, 218, 22);
		getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(261, 141, 218, 22);
		getContentPane().add(textField_1);
		textField_1.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(261, 229, 218, 22);
		getContentPane().add(textField_3);
		textField_3.setColumns(10);
		
		textField_4 = new JTextField();
		textField_4.setBounds(261, 286, 218, 22);
		getContentPane().add(textField_4);
		textField_4.setColumns(10);
		
		textField_5 = new JTextField();
		textField_5.setBounds(261, 348, 218, 71);
		getContentPane().add(textField_5);
		textField_5.setColumns(10);
		
		textField_6 = new JTextField();
		textField_6.setBounds(261, 456, 218, 22);
		...
		comboBox.setBounds(261, 184, 218, 21);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			try {
				...
				stmnt.executeUpdate("insert into addpatient values('"+patientID+"', '"+name+"', '"+gender+"','"+age+"', '"+contactno+"', '"+address+"', '"+bloodgroup+"')");
		...
		btnNewButton.setBounds(53, 556, 107, 38);
		...
		btnNewButton_1.setBounds(378, 553, 101, 41);
