...
public class addconsultation extends JFrame {
	...
	public addconsultation() {
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Dr. Divya K, MBBS, MD", "Dr.Joseph K, MBBS, MS", "Dr.Anitha R, MBBS", "Dr.Sam K, MBBS,MD", "Dr.Devi R, MBBS ,MS", "Dr.Reena M, MBBS, MS", "Dr. Chandran K, MBBS,MS", "Dr.Lakshmi S, MBBS,MD", "Dr.Ganesh R, MBBS,MS", "Dr.Soumya N, MBBS, MS", "Dr. Paul G, MBBS,MD", "Dr.Meena P, MBBS, MS", "Dr. Leena V, MBBS,MS", "Dr.Thomos A, MBBS, MD", "Dr. Fathima P, MBBS, MS"}));
		comboBox_1.setBounds(237, 243, 319, 25);
		...
		comboBox_2.setBounds(237, 287, 319, 25);
		...
		textField_4.setBounds(237, 206, 319, 25);
